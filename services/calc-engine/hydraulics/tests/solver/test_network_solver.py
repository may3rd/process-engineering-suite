...
from hydraulics.models.results import CalculationOutput
...
def test_solver_uses_section_pressures_for_components_forward():
    ...
    with patch("hydraulics.calculators.valves.ControlValveCalculator.calculate", new=fake_valve), patch(
        "hydraulics.calculators.orifices.OrificeCalculator.calculate", new=fake_orifice
    ):
