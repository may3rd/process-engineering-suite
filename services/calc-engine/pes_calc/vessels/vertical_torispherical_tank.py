"""Vertical torispherical tank geometry."""
...
class VerticalTorisphericalTank(VerticalTorisphericalVessel):
    """Vertical torispherical tank model."""

    vessel_type = "Vertical ToriSpherical Tank"
