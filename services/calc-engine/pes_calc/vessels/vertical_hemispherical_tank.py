"""Vertical hemispherical tank geometry."""
...
class VerticalHemisphericalTank(VerticalHemisphericalVessel):
    """Vertical hemispherical tank model."""

    vessel_type = "Vertical HemiSpherical Tank"
