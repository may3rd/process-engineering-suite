"""Export the running database contents to services/api/mock_data.json.

Usage (inside docker compose, where DATABASE_URL is set):
  docker compose -f infra/docker-compose.yml exec api python /app/services/api/scripts/export_db_to_mock.py
