...
from .units import UnitPrefix, Unit
...
UNITS = {
    ...
    '°R': Unit('°R', 'rankine', THETA=1, coef=D('1') / D('1.8')),
    ...
    'atm': Unit('atm', 'atmosphere', M=1, L=-1, T=-2, coef=D('101325')),
    'barg': Unit('barg', 'bar guage', M=1, L=-1, T=-2, coef=D('1E5'), offset=D('101325')),
    'psi': Unit('psi', 'pound per square inch', M=1, L=-1, T=-2, coef=D('6894.7572932')),
    'psig': Unit('psig', 'pound per square inch guage', M=1, L=-1, T=-2, coef=D('6894.7572932'), offset=D('101325')),
    'kcs': Unit('kcs', 'kilogram per square centimeter', M=1, L=-1, T=-2, coef=D('98066.5')),
    'kcsg': Unit('kcsg', 'kilogram per square centimeter guage', M=1, L=-1, T=-2, coef=D('98066.5'), offset=D('101325')),
    'kPag': Unit('kpag', 'kilogram per square centimeter guage', M=1, L=-1, T=-2, coef=D('1000'), offset=D('101325')),
    'torr': Unit('torr', 'torr', M=1, L=-1, T=-2, coef=D('133.3223684210526315789')),
    'mmWater': Unit('mmH2O', 'millimeter of water', M=1, L=-1, T=-2, coef=D('9.80665')),
