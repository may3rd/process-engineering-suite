...
/**
 * UomInput — Unit-convertible numeric input. 
 * Use for every numeric field that has a physical unit. 
 * The form always stores base units; conversion is display-layer only.
 */
        ...
        return (
          <div className="flex items-center gap-1.5">
            <Input
              ...
              className="flex-1"
            />
            <Select value={displayUnit} onValueChange={(newUnit) => setUnit(category, newUnit as any)}>
