...
export function EquipmentTab() {
  ...
  const summaryCards = useMemo(() => {
    const pressureVessels = equipment.filter((e) =>
      e.type.includes("vessel"),
    ).length;
    const inactiveCount = equipment.filter(
      (e) => e.status === "inactive",
    ).length;
    return [
      {
                  ...
                  >
                    ...
                    <Box>
                      ...
                      <Chip
                        ...
                        size="small"
                        color={
                          equip.status === "active" ? "success" : "default"
                        }
                        variant={
                          equip.status === "active" ? "filled" : "outlined"
                        }
            ...
            <Table>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell>
                    {renderHeader("Design Pressure", "designPressure")}
                  </TableCell>
                  <TableCell>{renderHeader("MAWP", "mawp")}</TableCell>
                  <TableCell>
                    {renderHeader("Design Temp", "designTemp")}
                  </TableCell>
      ...
      {equipmentToDelete && (
        <DeleteConfirmDialog
          ...
          children={[
            {
              label: "PSV Link",
              count: equipmentLinkList.filter(
                (link) => link.equipmentId === equipmentToDelete.id,
              ).length,
            },
          ]}
        />
